...
const Industries = () => {
  ...
  return (
    <section id="industries" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-orange-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {industries.map((industry, index) => {
            ...
            return (
              <div
                key={index}
                className="group relative bg-gradient-to-br from-orange-50/40 to-orange-50/40 backdrop-blur-sm rounded-xl p-6 border border-orange-200 hover:border-orange-400 transition-all duration-300 hover:shadow-lg hover:shadow-orange-200/20"
              >
        ...
        {/* CTA Section */}
        <div className="mt-16 bg-gradient-to-r from-orange-400 to-orange-500 rounded-2xl p-12 text-center border border-orange-500/50">
